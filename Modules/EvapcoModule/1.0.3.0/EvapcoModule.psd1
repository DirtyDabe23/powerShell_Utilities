#
# Module manifest for module 'EvapcoModule'
#
...
Copyright = '(c) 2025 Evapco. All rights reserved.'

# Description of the functionality provided by this module
Description = 'A comprehensive PowerShell module for Evapco administrative tasks including user management, device management, Jira integration, Active Directory operations, and server configuration.'
...
FunctionsToExport = @(
    ...
    'Get-EvapcoUser',
    'Get-EvapcoUserDevices',
    'Get-CimProgram',
    'Get-InTuneWindowsManagedDevices',
    'Get-InTuneApp',
    'Get-InTuneAppByDisplayName',    
    ...
    'Invoke-EvapcoSync',
    'New-CustomField',
    'New-DeviceGroupPerEvapcoLocation',
    'Remove-EvapcoDeviceAssignment',
    'Remove-TeamsCache',
    'Rename-EvapcoUser',
    'Set-DevEnvironment',
    'Set-EvapcoUserExtensionAttribute',
    'Set-JiraComment',
    ...
    'Start-SignEvapcoPsScript',
    'Start-WrapEvapcoModule',
...
PrivateData = @{
    ...
    PSData = @{
        ...
        Tags = @('Evapco', 'ActiveDirectory', 'Azure', 'Jira', 'DeviceManagement', 'UserManagement', 'Administration')
        ...
        ReleaseNotes = 'Initial release of EvapcoModule with comprehensive administrative functions for user management, device management, Jira integration, and server configuration.'
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDjycEYA+4471eC
# 2iqyHIB8UKMeWZtc8y/i5KgOoPED1qCCFAUwggWQMIIDeKADAgECAhAFmxtXno4h
...
# MAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEICXciDY1vlbqtVtz8LnJGw55
# +PM5/UYhSt91trxIEuf0MA0GCSqGSIb3DQEBAQUABIICAD3xZc7lxN1CZHUzDpIa
# 6mGaZ+f1zmC3fTrwENmLt0ZPJ0MftqF23A4fqaZU5TTRBL+giYMkrkD7WAxiHtr+
# gfRdR1mFnyVdr7a+9eECiyPm7BXw2s3nqgNug6S6q/gW8PBDE7bu4sGnuvoKIq0E
# hTSJktTurGiNOM73FRqgtYOwJBlpJUeBL4kqMool37Pi0seA4Y8SuEDm8NjAQwO4
# 0vOM6chyEKuJio76+TcWDTHe90ozqqXQYDweR33MVBa6etOyWe2rjLCbx/ewCR56
# lLUGcYgvpy/BXVhQkLH78AqRRFhBr1357FRhrjbxG6MfSRMj52NjNIv9FntJbIR9
# NFYfoqKN+c6qqViKmE/o8K8m6QoSeH9xe9z7iUpzwkafGhl31g/52DP9mPGFmRDc
# Rpf5nHA+A9sSlH7RCgpFGFlhtUg4jRtea6nEEHsWrilE0TtCaUaseBE4Dnq22R7y
# pLLR75xtIpzdEbbGwEbV7Zcia1aKKZUWPKIQRwDoJB25x6wbJv/Rk4Pgp7eFC20b
# 6WKmV/mgWw4vfqzHAml4ePTsnB5qq6NyTXxAcoFI6ID2wZbFiSRiZayDuZ1gK8io
# l9eGiPj65dXAJW6OWiAM7fHv3IR3RsYhRnl+F9R5nW1UwRrCfSYSIArzsHpxpk4D
# OkvaAsXsuY5DQR1huG0Y0g8IoYIWtzCCFrMGCisGAQQBgjcDAwExghajMIIWnwYJ
# KoZIhvcNAQcCoIIWkDCCFowCAQMxDTALBglghkgBZQMEAgEwgdwGCyqGSIb3DQEJ
# EAEEoIHMBIHJMIHGAgEBBgkrBgEEAaAyAgMwMTANBglghkgBZQMEAgEFAAQg335X
# ufXBHhXiKZmZJhvnTJlaJ8wT87j5cf1l5jSZgwMCFF3+ZojlnGLYDF7RuHS2MTAA
# 6UUqGA8yMDI1MDYyNDE5MDkyNlowAwIBAaBXpFUwUzELMAkGA1UEBhMCQkUxGTAX
...
# SAFlAwQCAaENBgkqhkiG9w0BAQsFADAvBgkqhkiG9w0BCQQxIgQgRsXiNa1ubG7P
# Ki1wM/s7fumswu0iO9H2xqEDh67kTokwgbAGCyqGSIb3DQEJEAIvMYGgMIGdMIGa
...
# m3hD4Jl1lGN3CzANBgkqhkiG9w0BAQsFAASCAYCYtW6dAZR0yqXw6/5/wWxMpADV
# /tS8yREJQBmXYl0YMNRdNn4eYvh3gdEWDyejsaGuHD5uDNRSD+8vnQxf78cKNOSn
# jePGQc91PXyRnS2/nsw3JM405YaaVIr5m6do6GRIGFUORVNRCG8CMZxjdz5biPws
# DFsgZsbfMXaAraXr4QHEIqoCe/H75eG9gyc0ejGqbDAf49syNvKZx+Xq7Pgr5OX8
# NN5rN0mDMMeLKOM/q7p45tC/gLY5jUuLaZXY4Fj78PHSyVXlbC5HZV5BJ8QCawfK
# LmQ7wFH5jVhO4t/UNiOGN5wQOsEWifZRk9Ktp+a256Ol02Es3o6mEM3nKXji25t/
# rcA1lSEwOje2GjNmU3L61n/01AsLRmGL71C7xWulMahcSXPrgLJwJcP2gvfAo/Af
# /GtuWK0v2KGuRS2cSA7QZmdsRO2loP45KNIELs8aNqdoUiyZMPYQpG7RFNnuw7Nx
# NRT8/wZOOWEQ4gBj6MiBCgGpXwsHqjch1EzHLcM=
