function Install-CustomModule{
    ...
    Install-CustomModule -moduleName "Start-BetterMessageTrace -localSource -localPath "C:\Users\$userName\uniqueParentCompany, Inc\GIT IT Support - Documents\General\Powershell Scripts\DDrosdick Scripts\____Modules\Start-BetterMessageTrace\0 - Prod\"
