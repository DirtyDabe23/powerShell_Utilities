...
$form = Invoke-RestMethod -Method Get -Uri "https://parentCompany.atlassian.net/rest/api/2/issue/$ticketNum" -Method Put -Body $jsonPayload -Headers $headers -ContentType "application/json" -SslProtocol Tls12 -HttpVersion 2.0 
