param(
        [Parameter(Position = 0, HelpMessage = "Is this a user who has an existing account at EVAPCO East?")]
...
$compuDataGroup1    =   Get-ADGroup -Identity "Citrix Cloud W11M Desktop Users" -server 'EVAPCO.com' -credential $myPsCred
$compuDataGroup2    =   Get-ADGroup -Identity "DocLink Users" -Server 'EVAPCO.Com' -credential $myPsCred
...
Add-ADGroupMember -identity $compuDataGroup1 -members $acctSAMName -server 'Evapco.com' -credential $myPsCred
Add-ADGroupMember -identity $compuDataGroup2 -members $acctSAMName -server 'Evapco.com' -credential $myPsCred
