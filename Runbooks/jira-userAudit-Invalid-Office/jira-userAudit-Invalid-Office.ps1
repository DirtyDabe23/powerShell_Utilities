...
#$validOfficeLocations = "EVAPCO East" , "EVAPCO West", "EVAPCO Midwest" , "EVAPCO Iowa" , "Refrigeration Vessels & Systems Corporation","EVAPCO Europe BVBA","EVAPCO (Milano) Europe, S.r.l.","EVAPCO (Sondrio) Europe, S.r.l.","EVAPCO (Beijing) Refrigeration Equipment Co., Ltd.","EVAPCO (Shanghai) Refrigeration Equipment Co., Ltd.","EVAPCO Australia (Pty.) Ltd.","EvapTech, Inc.","EVAPCO Dry Cooling, Inc.","Tower Components, Inc.","EVAPCO Newton","EVAPCO Europe A/S","EVAPCO Brasil","Fan TR","EVAPCO Alcoil, Inc.","EVAPCO Air Cooling Systems (Jiaxing) Co., Ltd.","EVAPCO Iowa Sales & Engineering","EVAPCO LMP","EVAPCO Select Tech","EVAPCO Europe GmbH","EvapTech Asia Pacific Sdn Bhd","EvapTech (Shanghai) Cooling Tower Co., Ltd." , "EVAPCO S.A. (Pty.) Ltd." , "EVAPCO Middle East DMCC"
...
$params = @{
    message = @{
        ...
        toRecipients = @(
            @{
                emailAddress = @{
                    address = "GIT-Helpdesk@evapco.com"
                }
            }
        )
        ccRecipients = @(
...
# CtCIGA8yMDI1MDQxNjEyNTAzOVowAwIBAaBXpFUwUzELMAkGA1UEBhMCQkUxGTAX
