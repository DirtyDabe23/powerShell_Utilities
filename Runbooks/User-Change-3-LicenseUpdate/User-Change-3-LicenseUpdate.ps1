...
"@ 
                    try {
                        $response = Invoke-RestMethod -Uri "https://evapco.atlassian.net/rest/api/2/issue/$jiraTicket/transitions" -Method Post -Body $jsonPayload -Headers $headers
                        if ($response){
                            $currTime = Get-Date -format "HH:mm"
                            Write-Output "[$($currTime)] | [$process] | [$procProcess] Internal Comment Successfully Made with Error Details"
                        }
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCNNjkCd0OciEez
# FD2n1btpFtnFfD2EbwPrTcyxzFjLd6CCFAUwggWQMIIDeKADAgECAhAFmxtXno4h
...
# MAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIDKkuNuJ2e3lPbATRv8kH2y4
# NGOcf12URUhcES6AEwwDMA0GCSqGSIb3DQEBAQUABIICAA4MQL0c7gCW9vd45doA
# Wj+ADVx5/JZEAoHQPLI7Tv+xDu2k6NHQM8m8zJg28hwfMWTR2qm45TIw8UVTfM9R
# 4K9oAJXfOc/KPR0ebT5wBFS1RwWJUahINR+aqvZ7ot/Vwfwc63Mknse6ft2G1kXn
# KUG4UM+eGXPyD35dh3Qru4aeyRRKQwQhfiWJUlhVbWDW6wCz4zuyFAdcfTVaC56K
# kUZxrCD0XqMLSbt4/TOtNrqckXH4Dot6Dkc+v/6gSFyyh26emfiVx3wTB+8SlwVc
# zJ2NPKv+IggKNK3sPdg/oW2B+xP9PIFKouFUCsE0UnwnTIbCOTpV3gOFYIbAbUpN
# Sfloph9JlOlT68qNxQkjGoMn6+PY0d9+H+BJLvVJOfHC9dFEjEUIZSHAQpHqbFOG
# e3/9zqdV/jtqlEEK041XLiNJJnIsoO8sPUdO3rzPEc4CPyrSAHZmloEeZptMeRnC
# QWNkfPT53dUfqgByTSdN+Zvg8Oh2JkEuZFttM2raVMuEAZyc99B0n4nA6hTbix2C
# Qardd1vrWbvCf8JnON90HQ9OyA+99p6obCGeC9VWLtp50BSEIxNbBsPqcFhALSDQ
# ECX9us38ad5UUG8XqXP6UHCHNf0Smynw9+nOSNANNxyd40wv/F71uUEvsGBjgeAH
# PY/TbMn0CXHVyn5XgmjfFMFcoYIWtzCCFrMGCisGAQQBgjcDAwExghajMIIWnwYJ
# KoZIhvcNAQcCoIIWkDCCFowCAQMxDTALBglghkgBZQMEAgEwgdwGCyqGSIb3DQEJ
# EAEEoIHMBIHJMIHGAgEBBgkrBgEEAaAyAgMwMTANBglghkgBZQMEAgEFAAQg3eMA
# YIP8FslL3DjknT1+Oyp+Yi4XGBI3QtrUiJei0voCFFaE7msKl8JSRo7y8GSgJts1
# 45nXGA8yMDI1MDYxMjE0MTg1N1owAwIBAaBXpFUwUzELMAkGA1UEBhMCQkUxGTAX
...
# SAFlAwQCAaENBgkqhkiG9w0BAQsFADAvBgkqhkiG9w0BCQQxIgQg8Ihnvc0+tYv0
# Rl6RtdN0rFHunYA1vRRzIgaWdyqJwLUwgbAGCyqGSIb3DQEJEAIvMYGgMIGdMIGa
...
# m3hD4Jl1lGN3CzANBgkqhkiG9w0BAQsFAASCAYC3OooEx+eI6wxD/+nolyTYsSEk
# 9jCtB6nJesTcBJ/CX2P7WML2v6hNFGPfmbOSx2qTwBCpFc8+MIuQMp4b5YWvUNPj
# CaHQIO8m9ow8Sr2DAz6bmABBnVyBXnMjGJIp758bXmZYrcMDWxcCRXb9HyV0zskR
# EO5wHZyXn/iPi2dwDVXrje1oOkU5Y+rL58h3ZVlEw4uxTgStnsxxNuboXIxjNJPb
# c2bXqTmDsUtTsjVs78NmjF2DBQ1txLcSzC+owLci01l9TpHSM1tTw1yv3KZhRUcy
# vGM3G6+XD7ksbgFhfHR2yWrGrpdS+vs5ON4H7+dS1b7nMff0bA/5KDvaXIWh5f8G
# c5RMg3JfzZK4En+/FhL1+Krd0yFiNkt5mpMnqvlHl7zXom2bQMY09dekEf6i0flr
# 1KBN8hrEUgkn4I7LGJz7S0GfBqhhYSjLZhg8DXf18/HjM05CcsJQU+GU8UEWJyCr
# bzTwP33epGto8vcGTMqPoW6KXTgAHKkL+DX0HMg=
