...
function Rename-EvapcoUser {
    ...
    Rename-EvapcoUser -CurrentUserName "TTestUserLast@domain.extension"

    .EXAMPLE
    #The following will update the user to the 'FirstName.LastName' format, without confirmation.
    Rename-EvapcoUser -currentUserName "testUser@domain.extension" -Auto
    
    .EXAMPLE
    #The following will rename a testUser@domain.extension and set the following properties
    Rename-EvapcoUser -currentUserName "testUser@domain.extension" -Auto -custom -newUPN "TestName.TestLast-NewLast@domain.extension" -firstName "tName" -lastName "lastName"
    #Properties Changed:
        ...
        try{
            ...
            while ($busySync -or ($waitedTime -lt 50))
            {
                ...
                If (Select-String -InputObject $syncErrorMessage -Pattern "The user name or password is incorrect.")
                {
                    ...
                    $evapcoCred = Get-Credential -Message "Enter your EVAPCO Admin Account Credentials that can remote into the AADC server.  The notation to use is Test.User@evapco.com"
                    $error.Clear()
                }
                else
                {
                    ...
                    $syncResult = Invoke-Command -ComputerName $syncServer -ScriptBlock {Start-AdSyncSyncCycle -PolicyType Delta} -Credential $evapcoCred -ErrorAction SilentlyContinue
    ...
    elseIf ($graphOrLocal -eq 1)
    {
        ...
        Else{
            ...
            If ($confirmation.substring(0,1) -eq 'Y'){
                ...
                $evapcoRenameJSON = $evapcoRenameHashTable | ConvertTo-JSON -Depth 1
                ...
                Invoke-RestMethod -uri $userGraphURI -Method Patch -Body $evapcoRenameJSON -Headers $graphAPIHeader -Verbose -Debug
...
try{
    ...
    Rename-EvapcoUser -currentUserName $originUPN -auto -ErrorAction Stop
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDolGcyDyetB8/g
# sLOtY0CQbKtgxrE78YNANTDnPXZ4bqCCFAUwggWQMIIDeKADAgECAhAFmxtXno4h
...
# MAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIExnYoe1/KrfOWFLWVWFZSJt
# KkB0I/1KCH2218ohOHK6MA0GCSqGSIb3DQEBAQUABIICAGU6BlB0Kn9qNCOLbuOp
# D9MT3FItZrDY1UE90h8bODTJeHPA6sF+cRdXnqt3HulYiJtmcf/QrfyYIiAxEWId
# 31iUnNCBn9OPwAfui05Lk4CVd6YBF0kPWNGxW3tIvLNaJrdHgoBCRohwgUKD7Du7
# pO61RL4FvG1XqApB278M6p6DlD9bJC/wt3Y8cX+Q2BZ3ICW8ws8dELLXhEB10wDr
# JCkZrP4xba7mgxFWUPDYCZuhboPriiPtAucy/1WlK5KExTKl8jwYIzhEEnVk5OuA
# elUXNiJTLVusl/rhG9mUwEbbj6NkQjUSZfIUV5YnctZOU6yMmonqMJa8WMgmUHuH
# uD0NCJJY7jJgSOIwaxAPMI1C4l307q/es+HnwyXA3pgJhMY/ylm7YwCkkpKrOXTb
# LcncEdIoXvvtUQMgiS457EeLzukkjfOcojjPassNcblxRgLc6tdB7boPBuZdcIuQ
# lt/T5de+gvX98tAbcUZ9zxpDJQb9qNA2P3kqUeL/D3WYmyC26gxU1kVgaBUCPQVk
# 5rKbwaYBBWY/t53WLYRXQ4/mg20HnIVecI1ZiCtrh4u8uk0sfW/dgx8IjaQlRqGL
# wZmteC6berV0o+k2n1ikDQesuudffcj9yEvIC23TsTUWNFDjC1paJilPHF1yYnma
# 4RpjNzETsBxm4ytlUyn8B/vGoYIWtzCCFrMGCisGAQQBgjcDAwExghajMIIWnwYJ
# KoZIhvcNAQcCoIIWkDCCFowCAQMxDTALBglghkgBZQMEAgEwgdwGCyqGSIb3DQEJ
# EAEEoIHMBIHJMIHGAgEBBgkrBgEEAaAyAgMwMTANBglghkgBZQMEAgEFAAQgV0BF
# 5WDEx3fokBzht2ZUcfDZOsUvBPC37a3BCtPiNGICFBHljUrwYtv8+jTQpal+E6tI
# /D3TGA8yMDI1MDYxMjE0MTg1NFowAwIBAaBXpFUwUzELMAkGA1UEBhMCQkUxGTAX
...
# SAFlAwQCAaENBgkqhkiG9w0BAQsFADAvBgkqhkiG9w0BCQQxIgQgTiqbeeGJsnFF
# G9HTdu8dGyF/qzM2Sfet2MT4jzalDKcwgbAGCyqGSIb3DQEJEAIvMYGgMIGdMIGa
...
# m3hD4Jl1lGN3CzANBgkqhkiG9w0BAQsFAASCAYBJbSc9OiY91UKb34xNtr/we4Gn
# EjJsyxjI1jm6TT2MGb+Aezd0p1CiE+Ruw5XH83zQRVKZwJ800wiv8yfGVfeiJSx/
# lzri3sKmVTp6KLsL9nH8Xd/CPGqhaEgPBs9zxuoH1ByUOo5+xa0bSzk/pqgzIZw4
# 0+Rr90vq82WsvIvJBkV1b3kBZA5+0N9uSoYbp9vfQvC1CQuh0heO433ssSvfU3ir
# 1EKI94t65SFpFwyA2JWifeolFNLzaZfKeA8rhq5IN9nLYTWU6spOl0WHNUuzlhLb
# OVITkvDg3b2hf6Mj7IyKME8E/MP4f/4oxyP/KAW6A2MCJk+hnSEC5K9tfTboKr4W
# fv9EttfIc7osOkNdLbnKU0KzU2HW0VhEYMlBWdIVPqAqwyFeJcgEg05yorim/roD
# aaJJr2qdwl1mS4+3Builc9EHq8Stmp9LJ8ToU/ER8vGUhbWPgSRBAWXKt8GQhoW/
# Dcc0U9CRaYmvghkhPJ16xNwgHb4NPEI5MPK54YI=
