...
switch ($originSynching) {
    $true {
        ...
        Invoke-parentCompanySync -SyncServerCred $cred
        ...
        While ($graphUserExists){
            ...
            invoke-command -ComputerName ServerAADC01.Domain.extension1 -ScriptBlock {Start-AdSyncSyncCycle -PolicyType Delta} -credential $cred -erroraction silentlycontinue
