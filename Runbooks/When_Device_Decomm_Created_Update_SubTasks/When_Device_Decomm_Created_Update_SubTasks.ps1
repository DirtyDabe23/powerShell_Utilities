...
Write-Output "Key is: $jiraTicket `n`n`n"
...
$response = Invoke-RestMethod -Uri "https://parentCompany.atlassian.net/rest/api/2/issue/$subTaskKey" -Method Put -Body $jsonPayload -Headers $jiraHeaders
