...
try{
    ...
    Connect-ExchangeOnline -ManagedIdentity -Organization evapcoinc.onmicrosoft.com -ManagedIdentityAccountID $managed_ID
}
catch {
    $errorMessage = $_
    Write-Output $errorMessage
...
$Form = Invoke-RestMethod -Method get -uri "https://evapco.atlassian.net/rest/api/2/issue/$jiraTicket" -Headers $jiraHeader
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBx6Ne4RdoIHVFa
# qAXa+55gwQWEFC3U4R78003L77RwJqCCFAUwggWQMIIDeKADAgECAhAFmxtXno4h
...
# MAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIM30oimHugTgVZGQwPyXFs6z
# jUjqNWJnPRfmP9RmPbdjMA0GCSqGSIb3DQEBAQUABIICAHwP9+sW36qrkq8Y66Ta
# pdMoUWsF53eSE047bvX3De/M30h4CRe/NEL31HZWtKmmXxSZXDxKylLo8nHk49tX
# t+cmCyqfylQCL6xhTDghDc2f3M+AmSAK8ThcuAsJ4UxK0JJuL2Nf3c9M5TFuhPId
# hfqnwPXxlP0aQYsGd31kgx2xhFQkN/55Bx/raGJ8hqy18HOAE9w6aythk/n31g3D
# Z4b50e0+HRceqnQdnpV4y1LEP45+saDKZA2eg830WFz/EDlAxJXf9XVVsp65xfBl
# xWckRT8xVIQkbIQpcdDo9rt3heU/arZSXKFxULYQ64stYN8SzA+8hLj75RT5M+JO
# GZX9CJmCmO8MiJgl630Bwr0w2AyseW71LdjbcZpJp9uKPeBXuLSDXFIsYX6qTNet
# rGAy+P4JRBGn22XENukm0twYDJFWx0Y7jJLBTEzucTBKi+q1TsVaeKjACsKAHZ7o
# n2NFR/KkZoDJgI2bZG4NXOIdtXCqXMr1HqOVm/rwFXFnAisX0TTbDHd8fZpXCljJ
# lFjP5VTT8e+Ajh/oRlQlREZU8POHZsBcDeiVqLxwvNSeIXATNjN8CAUF3XHixwlV
# aQWO4d50UuRvbVKIv520NtbNfWG7uKBRBig7/+tFhXHuZnESwaEQz7sMshI8s4qN
# nkBy4qsjrcR12bwJpZZBA+wwoYIWtzCCFrMGCisGAQQBgjcDAwExghajMIIWnwYJ
# KoZIhvcNAQcCoIIWkDCCFowCAQMxDTALBglghkgBZQMEAgEwgdwGCyqGSIb3DQEJ
# EAEEoIHMBIHJMIHGAgEBBgkrBgEEAaAyAgMwMTANBglghkgBZQMEAgEFAAQgUDPr
# R15krxIGS9zGpc88pXZzLRUTM+BVjiXBlWh3tHACFCoIueBCvLLgCo5fBl96jUTt
# g2S2GA8yMDI1MDYxMjE0MTg0MlowAwIBAaBXpFUwUzELMAkGA1UEBhMCQkUxGTAX
...
# SAFlAwQCAaENBgkqhkiG9w0BAQsFADAvBgkqhkiG9w0BCQQxIgQgItLaYSzfqzuz
# RjjAIu/T0Ji/BxV+RyC2PgbfT0O5SG4wgbAGCyqGSIb3DQEJEAIvMYGgMIGdMIGa
...
# m3hD4Jl1lGN3CzANBgkqhkiG9w0BAQsFAASCAYCCgKQvPaJ5G5LbiR98aXvP0qZ4
# aaEvyzaCQ6abMJTYSDRpqrHgUM5441vykN77PlG53uTuSq/ipyRHz9j6RyVMrvKd
# +1LZjzS/izS1osGutp3dGNrHRs7OQEEq1vrrOYd26/r8ISmmCxa8yfgiEZlEcrg8
# fEofMGWZjTd+epJPb+OdF5btoQTvVGRQsuRjJXXvybi7e1ToRWGxQ2FPY3G8Q7+T
# /wviR+45WpxFAh8TFK8+pVC/yVEPRPIPMbEZ75ho1IhhK7wc7X4zukzZ1HNEbMT2
# qPmvDmupj5eD7xYZ9Dl3o/TsmApeLKL2KcVMlqJb8q6Mbz8bLmw8HzOU41Sj+BJh
# wAMPWjD6hBmPgLGjHd0KFszQdraHP5ru4Rm2CUZa8L9WjTXww09bmKpyMKJAD73v
# DFbUzvejLioiA2BQgPdwxBSCpiHA4Q/+klyQqAQLZnpPnfAFmBKGh2ookt8ikCIb
# VUhm5BhO7wPClnyu9yySxexDOAh3Dwr43y4mDuA=
