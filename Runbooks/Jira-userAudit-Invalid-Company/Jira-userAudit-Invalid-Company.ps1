...
#$validCompanyNames = "EVAPCO, Inc.","EVAPCO Alcoil, Inc.","EVAPCO Dry Cooling, Inc.","Refrigeration Vessels & Systems Corporation","EvapTech, Inc.","Tower Components, Inc.","EVAPCO Refrigeration Equipment Co., Ltd","EVAPCO Air Cooling Systems Company, Ltd","FanTR Technology Resource","EVAPCO LMP","EVAPCO Select Technologies, INC.","EVAPCO Australia (Pty.) Ltd.","EVAPCO Europe GmbH","EVAPCO Europe A/S","EVAPCO Iowa Sales & Engineering","EVAPCO Europe, S.r.l.","EVAPCO Europe BVBA","EvapTech (Shanghai) Cooling Tower Co., Ltd.","EvapTech Asia Pacific Sdn Bhd","EVAPCO Brasil" , "EVAPCO Middle East DMCC" , "EVAPCO S.A. (Pty.) Ltd."
