...
"@
try {
    Invoke-RestMethod -Uri "https://evapco.atlassian.net/rest/api/2/issue/$jiraTicket" -Method Put -Body $jsonPayload -Headers $jiraHeader -erroraction Stop | Out-Null
    $currTime = Get-Date -format "HH:mm"
    Write-Output "[$($currTime)] | [$process] | [$procProcess] Internal Comment Successfully Made with Error Details"
    }
 catch {
...
$partneredEvapcoLocation =  $form.fields.customfield_10820.value
...
if ($attachment) {
    ...
    ForEach ($user in $csv){
        ...
        $groupName = $partneredEvapcoLocation , ": UC - Vendor - " , $invitedUserCompanyName, " ", $user.accessLevel -join ""
        If (!(Get-MgGroup -Filter "DisplayName eq  '$groupName'")){
            ...
            $formattedEvapcoLocation = $($partneredEvapcoLocation).replace(",","").replace(" ","").replace(".","")
            $groupMailNickName = $formattedEvapcoLocation , $FormattedCompanyName , $user.accessLevel -join ""
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDNvFO0I2c4TZ1A
# v9TBIv8KKrv+SB9jyZjJ2F5EUyUCk6CCFAUwggWQMIIDeKADAgECAhAFmxtXno4h
...
# MAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIIAXf59mvMdYSoVj2rsfSkun
# ef6g9FNpXuQbpa+Kf3yDMA0GCSqGSIb3DQEBAQUABIICACq5fyFyj9dzfpK7iADx
# rJj+oa1o68Kyb3aQm5XqZF+EoOwBvnuwcL4RbsnR+UO9GZgHZi8V5ZE33HjNzFgn
# BFRm0p1KyO2JXuD6AcbuEPkkLBOEsrcRzePkAjhHONo9CSQkXtMeDktimPhnIsA5
# /TYwsSt5AamztLNnfXocLuEjepfsQYQsmwuXrfIGmdz7A82/xIAc/3vwZumLHDJl
# zDjMKqVJ7xrEp8/wzih0xDF4Y3H3hnODnxVGnCy6bw2ygUVcv9Ro+AvvMdQCnRyf
# zb5HqxsgbGSOVONScUoCayJm7RY6Pmh1DKhAZxxOuT6QYcbNbT3hNFL3+dsTKAUP
# YzvZMXCoeY0VEE+JcQCwGH8kavj2E2fnhU4FPNcP4V+JxYEYzd/N1CfXdxrT2Igm
# TSUIMBB/JVLygt18T/oo5VxpZAW7I9NwV/455Cx3Ny0FGPlzG4rMOpCf+yVLBKzv
# Yh5ibn3JSvAVNmtjAyrm7xwg+ivu9RpBkSO5T6QYsE8FfEtEOmji5rW/vgrhShYA
# 1gzH5jKXH4HlDcOBt8wIs9tVrMrkWVTjST2XhYd4v093s0Ff8zqGvo/1UzyS7Shy
# n/YHbomdQXu2uGpXfiCFgrjiFwfa6BVdZ5j3K1LdPJ6/mJfpjIRnFzFmcn/XloRM
# pvBJH/7S7RJ1Er8vS7uiseCSoYIWtzCCFrMGCisGAQQBgjcDAwExghajMIIWnwYJ
# KoZIhvcNAQcCoIIWkDCCFowCAQMxDTALBglghkgBZQMEAgEwgdwGCyqGSIb3DQEJ
# EAEEoIHMBIHJMIHGAgEBBgkrBgEEAaAyAgMwMTANBglghkgBZQMEAgEFAAQg/HM4
# ReQkwFDXgjNTHGOG90H+RoaPKD4/b75e9x6lraMCFG/B8Y8GWhdu9yuDiRC7bQXK
# G24VGA8yMDI1MDYxMjE0MTg0M1owAwIBAaBXpFUwUzELMAkGA1UEBhMCQkUxGTAX
...
# SAFlAwQCAaENBgkqhkiG9w0BAQsFADAvBgkqhkiG9w0BCQQxIgQgo98jMNvFhKcd
# y2AsXo9vBeg2bPd/T8X06NYtIS9EpjcwgbAGCyqGSIb3DQEJEAIvMYGgMIGdMIGa
...
# m3hD4Jl1lGN3CzANBgkqhkiG9w0BAQsFAASCAYByLBTv8A4sI/WJpuSh5vTjEdlK
# dHErsWd4vFLchdOjeL5cIrx27anSdd4Vr3uLEOrHJMqMz4P3Vsu0NPeuCgxtCpz2
# JbHVuHKDgjJji5Km8452N+BPw9S2jpmqWOjmok5/zRyDORhF2hkTn3j3FcNF7mMb
# 5n1wg8m1wRwdNKrU+n5KRpaDzeg/egaLM7ECNeE4Ml0hfAf2IsmObF5LMSdJQWEg
# 1gXpY281jYNm29pajyPTL3d6mDsC2T/92SFKq1vBbNJL6f197az3MWjA7fbXX/79
# zkNFs03c5fpWrkjo0o9QhAKmSHREv5HZ9o6OnI4J02F9NAzLIo06XLRvqnPtI+9A
# ITRxyZqh6/X+ml2fSCm9/H7DbDBJXAspGdu+OKDMZjUtLZ3b8YTYEMVjZmBDO3Kg
# +rAlxphV3aKkf8Q6r8QxZM/muejiXs/b73i6p5I23JrkyES+H++m8tNYcqd/GhLA
# pPbYUtP8RBWMRMPXMwKn+0z8zREhv+1RaL+LJb4=
