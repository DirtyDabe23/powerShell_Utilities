...
$base64AuthInfo = [Convert]::ToBase64String([Text.Encoding]::ASCII.GetBytes(("david.drosdick@evapco.com:$password")))
...
$body = "id=1&name=David%20Drosdick&email=David.Drosdick%40evapco.com&contact=4107562600&location=EVAPCO%20East&create_new=false"
...
email=David.Drosdick%40evapco.com&
contact=4107562600&
location=EVAPCO%20East&
create_new=false
"
...
#delete End Users
$apiUrl = "https://itam.evapco.com/api/1.0/endusers/$ID/"
