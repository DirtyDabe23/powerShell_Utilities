...
$device42URL = 'https://itam.Domain.extension1'
...
$Issue = Invoke-RestMethod -Method get -uri "https://parentCompany.atlassian.net/rest/api/2/issue/$TicketNum" -Headers $jiraHeaders
