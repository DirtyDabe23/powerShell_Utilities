$compuDataOUUsers = Get-ADUser -filter * -searchbase "OU=CompuData - External Sage Users - Non-Synching,DC=EVAPCO,DC=COM" -properties * | select-object -Property DisplayName, UserPrincipalName, SAMAccountName, GivenName, Surname | sort-object -property surname 
