...
$search = "OU=Evpco Users,DC=evapco,DC=mn"
#OU=Users,OU=Office,OU=End Users,OU=AD-Midwest,DC=greenup,DC=evapco,DC=com
...
# 34+6bKydaX7ijDcEYxbmg447gYKyhKiVQnuVBFWTfYWUNUuTgaJRVSXDIWrgiZAg
