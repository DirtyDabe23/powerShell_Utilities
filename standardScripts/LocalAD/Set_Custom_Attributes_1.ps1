...
Get-ADUSer -filter * -SearchBase "ou=Employees,DC=EVAPCO,DC=COM" | Where-Object {($_.DistinguishedName -notlike "*OU=Shop*")} | Select-Object -Property UserPrincipalName | Sort-Object -Property UserPrincipalName
