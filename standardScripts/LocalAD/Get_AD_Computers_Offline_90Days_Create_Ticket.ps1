...
$offline90DaysComputers = Invoke-Command -ComputerName ServerDC01 -ScriptBlock $command
...
$messageContent = @"
Please review the attachment for a list of parentCompany East Domain Joined Computers that have not been seen in over 90 days.
...
$params = @{
    message = @{
        subject = "parentCompany East: Devices Offline for 90+ Days"
        body = @{
            contentType = "Text"
