...
$messageContent = @"
Please review the attachment for a list of EVAPCO East Domain Joined Computers that have not been seen in over 90 days.
...
$params = @{
    message = @{
        subject = "EVAPCO East: Devices Offline for 90+ Days"
        body = @{
            contentType = "Text"
