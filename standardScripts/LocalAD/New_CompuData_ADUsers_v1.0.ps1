...
$compuDataUsers = Import-CSV -Path "\\parentCompanyusers\departments\Public\Tech-Items\Script Configs\compuDataUsers.csv"
$errorUsers = @()
...
ForEach ($user in $compuDataUsers)
{
    ...
    try
    {
        ...
        Else
        {
            ...
            #Create the UPN
            $UPN = $user.'Primary Local AD'+"@Domain.extension1"
