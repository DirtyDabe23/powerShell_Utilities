...
$messageContent = "GIANT'S GIANT'S GIANT'S. BECOME UNSTOPPABLE"
$remoteImageDestination = "C:\GIT_Scripts\"
$remoteImageName = $remoteImageDestination , $notificationImageName -join ""

Invoke-Command -Session $session -ScriptBlock {
        invoke-webrequest -Uri "https://media1.tenor.com/m/Lw4bHaMBwEsAAAAC/dark-souls-thepruld-git-gud-giant-dad.gif" -OutFile $using:remoteImageName
