...
$scheduledTasks = Import-CSV -Path "\\parentCompanyusers\departments\public\tech-items\Script Configs\Scheduled_Tasks.csv"

# Specify the user account to run the scheduled tasks
$user = "David.Drosdickadmin@Domain.extension1"
