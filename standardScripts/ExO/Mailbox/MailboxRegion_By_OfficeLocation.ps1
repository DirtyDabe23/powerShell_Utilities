...
switch ($office) {
    'EvapTech, Inc.' {$mailboxRegion = "NAM"
    $usageLocation = "US"}
    'EVAPCO Select Tech'{$mailboxRegion = "NAM"
    $usageLocation = "US"}
    'EVAPCO (Beijing) Refrigeration Equipment Co., Ltd.'{$mailboxRegion = "NAM"
    $usageLocation = "CN"}
    'EVAPCO Europe A/S'{$mailboxRegion = "EUR"
    $usageLocation = "DK"}
    'EVAPCO Midwest'{$mailboxRegion = "NAM"
    $usageLocation = "US"}
    'EVAPCO (Shanghai)  Refrigeration Equipment Co.,Ltd'{$mailboxRegion = "NAM"
    $usageLocation = "CN"}
    'Indaiatuba'{$mailboxRegion = "IND"
    $usageLocation = "IN"}
    'Refrigeration Vessels & Systems Corporation'{$mailboxRegion = "NAM"
    $usageLocation = "US"}
    'EVAPCO LMP'{$mailboxRegion = "CAN"
    $usageLocation = "CA"}
    'EVAPCO Alcoil, Inc.'{$mailboxRegion = "NAM"
    $usageLocation = "US"}
    'Fan TR'{$mailboxRegion = "BRA"
    $usageLocation = "BR"}
    'EVAPCO (Shanghai) Refrigeration Equipment Co., Ltd.'{$mailboxRegion = "NAM"
    $usageLocation = "CN"}
    'EvapTech (Shanghai) Cooling Tower Co., Ltd.'{$mailboxRegion = "NAM"
    $usageLocation = "CN"}
    'Itu'{$mailboxRegion = "EUR"
    $usageLocation = "IT"}
    'EVAPCO East'{$mailboxRegion = "NAM"
    $usageLocation = "US"}
    'EVAPCO Air Cooling Systems (Jiaxing) Co., Ltd.'{$mailboxRegion = "NAM"
    $usageLocation = "CN"}
    'EVAPCO Iowa'{$mailboxRegion = "NAM"
    $usageLocation = "US"}
