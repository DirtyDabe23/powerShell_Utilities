...
Get-DistributionGroupMember -Identity "parentCompany TT Conference Rooms" | Sort Displayname | Format-Table DisplayName, RecipientTypeDetails
...
Set-Place -Identity "parentCompany Iowa - Bldg. A Conference Room" -CountryOrRegion "US" -City "Lake View" -Floor 2 -MTREnabled $true -Capacity 24 -Street "Address2" -Building "Building A" -State IA -PostalCode 51450 -Phone “PhoneNumber23" -Label "parentCompany Iowa - Building A Conference Room" -VideoDeviceName "Teams Meeting Device" -DisplayDeviceName "Teams Meeting Device" -AudioDeviceName "Teams Meeting Device" -Tags BuildingA, Tag2, Iowa
...
Set-Place -Identity "parentCompany Iowa - Bldg. B Conference Room" -CountryOrRegion "US" -State IA -PostalCode 51450 -City "Lake View" -Street "Address2" -Building "Building B" -Floor 2 -MTREnabled $false -Capacity 24 -Label "parentCompany Iowa - Building B Conference Room" -Tags BuildingB, Iowa
SignatureBlock
