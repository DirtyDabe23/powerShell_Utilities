...
Get-DistributionGroupMember -Identity "Evapco TT Conference Rooms" | Sort Displayname | Format-Table DisplayName, RecipientTypeDetails
...
Set-Place -Identity "EVAPCO Iowa - Bldg. A Conference Room" -CountryOrRegion "US" -City "Lake View" -Floor 2 -MTREnabled $true -Capacity 24 -Street "925 Quality Drive" -Building "Building A" -State IA -PostalCode 51450 -Phone “+1 712 657 3223" -Label "EVAPCO Iowa - Building A Conference Room" -VideoDeviceName "Teams Meeting Device" -DisplayDeviceName "Teams Meeting Device" -AudioDeviceName "Teams Meeting Device" -Tags BuildingA, Videoconference, Iowa
...
Set-Place -Identity "EVAPCO Iowa - Bldg. B Conference Room" -CountryOrRegion "US" -State IA -PostalCode 51450 -City "Lake View" -Street "925 Quality Drive" -Building "Building B" -Floor 2 -MTREnabled $false -Capacity 24 -Label "EVAPCO Iowa - Building B Conference Room" -Tags BuildingB, Iowa
...
# z+9k6SdcwuTcIa2pJlRi4C2gk4k+oP48STjTP/mFwcrCr1P6C81AOwsxAEkZKfSl
