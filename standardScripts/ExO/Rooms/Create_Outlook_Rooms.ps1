New-Mailbox -Name "EVAPCO Europe BVBA - Room 1" -DisplayName "EVAPCO Europe BVBA - Room 1" -Room
New-Mailbox -Name "EVAPCO Europe BVBA - Room 2" -DisplayName "EVAPCO Europe BVBA - Room 2" -Room
New-Mailbox -Name "EVAPCO Europe BVBA - Room 3" -DisplayName "EVAPCO Europe BVBA - Room 3" -Room
New-Mailbox -Name "EVAPCO Europe BVBA - Production Meeting Room" -DisplayName "EVAPCO Europe BVBA - Production Meeting Room" -Room


Add-DistributionGroupMember -Identity "EVAPCO Europe BVBA Conference Rooms" -Member "EVAPCO Europe BVBA - Room 1"
Add-DistributionGroupMember -Identity "EVAPCO Europe BVBA Conference Rooms" -Member "EVAPCO Europe BVBA - Room 2"
Add-DistributionGroupMember -Identity "EVAPCO Europe BVBA Conference Rooms" -Member "EVAPCO Europe BVBA - Room 3"
Add-DistributionGroupMember -Identity "EVAPCO Europe BVBA Conference Rooms" -Member "EVAPCO Europe BVBA - Production Meeting Room"


Set-Place -Identity "EVAPCO Europe BVBA - Room 1" -CountryOrRegion "BE"  -City "Tongeren" -Building "Office" -Floor 0 -MTREnabled $true -Capacity 16 -Label "EVAPCO Europe BVBA - Room 1" 
Set-Place -Identity "EVAPCO Europe BVBA - Room 2" -CountryOrRegion "BE"  -City "Tongeren" -Building "Office" -Floor 0 -MTREnabled $false -Capacity 6 -Label "EVAPCO Europe BVBA - Room 2" 
Set-Place -Identity "EVAPCO Europe BVBA - Room 3" -CountryOrRegion "BE"  -City "Tongeren" -Building "Office" -Floor 0 -MTREnabled $false -Capacity 6 -Label "EVAPCO Europe BVBA - Room 3"
Set-Place -Identity "EVAPCO Europe BVBA - Production Meeting Room" -CountryOrRegion "BE" -City "Tongeren" -Building "Office" -Floor 0 -MTREnabled $true -Capacity 12 -Label "EVAPCO Europe BVBA - Production Meeting Room"
