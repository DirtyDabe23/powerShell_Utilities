...
$EmailAddr = "AM.Invoice@evapcodc.com"
$groupName = "EVAPCO Dry Cooling, Inc. - AM Invoice"
$groupDescrip = "EVAPCO Dry Cooling, Inc. - AM Invoice"
$groupOwner = "david.drosdick@evapco.com"
...
Add-RecipientPermission $EmailAddr -AccessRights SendAs -Trustee "jared.miller@evapcodc.com" -Confirm:$false
Add-RecipientPermission $EmailAddr -AccessRights SendAs -Trustee "patrick.saussus@evapcodc.com" -Confirm:$false
