$DistroMembers = Get-DistributionGroupMember -identity "ESOP-PSIP-Distro@evapco.com" -resultsize unlimited
$csvUsers = Import-CSV -path "C:\Users\David.drosdick\OneDrive - Evapco, Inc\Documents\_Project\_Distribution_Groups\ESOP\Email_Distribution_List_ESOP_PSIP.csv"
