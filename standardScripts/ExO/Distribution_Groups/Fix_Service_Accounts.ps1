...
$serviceaccounts = Import-CSV -path "C:\Users\$userName\OneDrive - uniqueParentCompany, Inc\Documents\_Project\_Dynamic_Groups\ESOP_Group\Working\ServiceAccounts.csv"
