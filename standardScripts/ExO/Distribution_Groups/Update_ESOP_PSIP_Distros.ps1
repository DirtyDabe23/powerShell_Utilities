$users = Import-CSV -path "C:\Users\david.drosdick\Evapco, Inc\GIT IT Support - General\Reports\2024\ESOP-PSIP\Source\ESOP.csv"
Update-DistributionGroupMember -Identity "esop-only-distro@evapco.com" -Members $users.emailaddress  -Confirm:$false

$users = $null

$users = Import-CSV -path "C:\Users\david.drosdick\Evapco, Inc\GIT IT Support - General\Reports\2024\ESOP-PSIP\Source\PSIP.csv"
Update-DistributionGroupMember -Identity "psip-only-distro@evapco.com" -Members $users.emailaddress  -Confirm:$false


$users = $null

$users = Import-CSV -path "C:\Users\david.drosdick\Evapco, Inc\GIT IT Support - General\Reports\2024\ESOP-PSIP\Source\ESOP-PSIP.csv"
Update-DistributionGroupMember -Identity "esop-psip-distro@evapco.com" -Members $users.emailaddress  -Confirm:$false
