...
ForEach ($distroIdent in $distroArr)
{
    ...
    Get-DistributionGroupMember -Identity $distro -ResultSize Unlimited | Select DisplayName, PrimarySmtpAddress, EmailAddresses | Sort DisplayName | Export-CSv -Path "C:\Users\david.drosdick\Evapco, Inc\GIT IT Support - General\Reports\2024\ESOP-PSIP\Backup\$($fileName)"
}
