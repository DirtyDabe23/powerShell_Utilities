...
Update-DistributionGroupMember -Identity "IllinoisHealthCompliance@evapco.com" -Members $IL_Employees.emailaddress  -Confirm:$false

$EE_Employees = Import-CSV -Path "C:\Temp\EE_Employees.csv"
Update-DistributionGroupMember -Identity "GlobalHealthCompliance@evapco.com" -Members $EE_Employees.emailaddress  -Confirm:$false
