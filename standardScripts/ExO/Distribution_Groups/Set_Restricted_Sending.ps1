...
Get-DynamicDistributionGroup -identity 'AllIntlEmployees@evapco.com' | Set-DynamicDistributionGroup -RequireSenderAuthenticationEnabled $False 
Get-DynamicDistributionGroup -identity 'AllNorthAmericaEmployees@evapco.com' | Set-DynamicDistributionGroup -RequireSenderAuthenticationEnabled $False 

Start-Sleep -Seconds 3600
Connect-ExchangeOnline
Get-DynamicDistributionGroup -identity 'AllIntlEmployees@evapco.com' | Set-DynamicDistributionGroup -RequireSenderAuthenticationEnabled $True -AcceptMessagesOnlyFrom "evapco@evapco.com","sstoll@evapco.com","kevin.williams@evapco.com","jarrod.stebick@evapco.com","git-helpdesk@evapco.com"
Get-DynamicDistributionGroup -identity 'AllNorthAmericaEmployees@evapco.com' | Set-DynamicDistributionGroup -RequireSenderAuthenticationEnabled $True -AcceptMessagesOnlyFrom "evapco@evapco.com","sstoll@evapco.com","kevin.williams@evapco.com","jarrod.stebick@evapco.com","git-helpdesk@evapco.com"
