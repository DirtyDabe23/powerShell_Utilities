...
{
    $baseID = "*@" + $domain.id 
    Get-QuarantineMessage -RecipientAddress "Git-helpdesk@Domain.extension1"  | Where-Object {($_.SenderAddress -like $baseID) -and ($_.ReleaseStatus -eq "NOTRELEASED")} | Release-QuarantineMessage -releasetoall -allowsender -reportfalsepositive -actionType "Release"
