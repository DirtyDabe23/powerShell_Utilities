...
$jiraRetrSecret = (Invoke-RestMethod -Uri "https://KeyVaultName.vault.azure.net/secrets/$($vaultName)?api-version=2016-10-01" -Method GET -Headers @{Authorization="Bearer $jiraToken"}).value
...
$exportPath = "\\parentCompanyusers\departments\public\Tech-Items\scriptLogs\$(get-date -format yyyy-MM-dd)-cyops-ghd-tickets.csv"
...
$AffectedparentCompanyLocations =  $AffectedparentCompanyLocations.AffectedparentCompanyLocation | Select-Object -Unique
...
$AffectedparentCompanyLocationsTicketCount = $AffectedparentCompanyLocationsTicketCount | sort-object -Property Count -Descending 
