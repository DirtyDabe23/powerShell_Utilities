...
$exportPath = "\\evapcousers\departments\public\Tech-Items\scriptLogs\$(get-date -format yyyy-MM-dd)-cyops-ghd-tickets.csv"
...
$AffectedEVAPCOLocations =  $AffectedEVAPCOLocations.AffectedEVAPCOLocation | Select-Object -Unique
...
$AffectedEVAPCOLocationsTicketCount = $AffectedEVAPCOLocationsTicketCount | sort-object -Property Count -Descending 
