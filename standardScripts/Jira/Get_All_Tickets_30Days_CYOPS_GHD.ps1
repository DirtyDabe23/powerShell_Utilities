...
#Jira Header
$jiraText = "david.drosdick@evapco.com:$retrSecret"
...
$ticketsMatching = @()
$uriTemplate = "https://evapco.atlassian.net/rest/api/2/search?jql=project%20in%20(CYOPS,GHD)%20AND%20created%20%3E%3D%20-$numberofDays&startAt={0}"
...
# SAPFMta6Wtci6yC8MnaTqjRMLBnHy171sV+xcXJYnZ4LrkJuNGLXwCi7FAJGoOkP
