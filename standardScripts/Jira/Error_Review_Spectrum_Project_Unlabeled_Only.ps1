...
$ticketsMatching = @()
$uriTemplate = "https://parentCompany.atlassian.net/rest/api/2/search?jql=project%3Dspec%20AND%20labels%20%3D%20EMPTY&startAt={0}"
...
$exportPath = "\\parentCompanyusers\departments\public\Tech-Items\scriptLogs\error_report.csv"
