...
$Issue = Invoke-RestMethod -Method get -uri "https://evapco.atlassian.net/rest/api/2/issue/$TicketNum" -Headers $headers
...
Invoke-RestMethod -Uri "https://evapco.atlassian.net/rest/api/2/issue/$($subTaskKey)" -Method Put -Body $jsonPayload -Headers $jiraHeaders
