...
$citrixPath= "\\parentCompanyusers\departments\Public\Tech-Items\Software\Citrix\Citrix243197.exe"
$uninstaller = "\\parentCompanyusers\departments\public\tech-items\software\citrix\ReceiverCleanupUtility.exe"
$errorLog = @()
