...
$citrixPath= "\\evapcousers\departments\Public\Tech-Items\Software\Citrix\Citrix243197.exe"
$uninstaller = "\\evapcousers\departments\public\tech-items\software\citrix\ReceiverCleanupUtility.exe"
$errorLog = @()
