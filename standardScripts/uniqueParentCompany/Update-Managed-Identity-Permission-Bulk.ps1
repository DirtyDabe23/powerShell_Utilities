...
$principalDisplays = @('PREFIX-VS-MGMT01','Azure-DC01', 'US-CA-VS-DC01','US-KS-VS-DC01', 'US-MN-VS-DC01','US-NC-VS-DC01','DC2','subsidiaryCompany1-shortName-DC1','uniqueParentCompanyAlcoilSrv')
