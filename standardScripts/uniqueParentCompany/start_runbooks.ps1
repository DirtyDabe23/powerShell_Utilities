...
start-azautomationRunbook -AutomationAccountName "AutomationAccount1" -Name "User-Transfer-5-create-local-74" -ResourceGroupName "uniqueParentCompanyGIT" -RunOn $destinationHybridWorkerGroup  -Parameters $destinationRunbookParameters  -Wait
