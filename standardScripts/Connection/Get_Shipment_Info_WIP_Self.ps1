...
If ($MatchingOrder.count -gt 1)
{
    ...
    ForEach ($order in $matchingOrder)
    {
        ...
        Invoke-RestMethod -Uri "https://evapco.atlassian.net/rest/api/2/issue/$($key)" -Method Put -Body $jsonPayload -Headers $jiraHeaders  
    }
}
else 
{
...
# RQqTaHpcH7YSysdA2KrywqJUGt3n+k3MtCi9yYSfDKLw3zslIEc88BlrKmuj1ALk
