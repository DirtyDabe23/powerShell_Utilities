...
$d42retrSecret = (Invoke-RestMethod -Uri "https://KeyVaultName.vault.azure.net/secrets/$($d42VaultName)?api-version=2016-10-01" -Method GET -Headers @{Authorization="Bearer $d42Token"}).value
...
$connectionRetrSecret = (Invoke-RestMethod -Uri "https://KeyVaultName.vault.azure.net/secrets/$($connectionVaultName)?api-version=2016-10-01" -Method GET -Headers @{Authorization="Bearer $connectionToken"}).value
