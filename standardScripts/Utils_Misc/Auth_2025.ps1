...
$Form = Invoke-RestMethod -Method get -uri "https://evapco.atlassian.net/rest/api/2/issue/$TicketNum" -Headers $jiraHeader -ContentType "application/json" -SslProtocol Tls12 -HttpVersion 2.0 
Write-Output $Form
...
$d42apiURL = 'https://itam.evapco.com/api/1.0/endusers/'
...
$connectionAuthURI = "https://api.moredirect.com/service/rest/auth/oauth2?grant_type=PASSWORD&password=$connectionRetrSecret&username=GIT-CYOPS-Technical%40evapco.com"
# Get Authentication Token
