...
$Form = Invoke-RestMethod -Method get -uri "https://parentCompany.atlassian.net/rest/api/2/issue/$TicketNum" -Headers $jiraHeader -ContentType "application/json" -SslProtocol Tls12 -HttpVersion 2.0 
Write-Output $Form
...
$d42apiURL = 'https://itam.Domain.extension1/api/1.0/endusers/'
...
$connectionRetrSecret = Get-AzKeyVaultSecret -VaultName "KeyVaultName" -Name "ConnectionAPI" -AsPlainText
...
#Connection
#$connectionAuthURI = "https://api.webqa.moredirect.com/service/rest/auth/oauth2?grant_type=PASSWORD&password=$connectionRetrSecret&username=GIT-CYOPS-Technical%40Domain.extension1"

$connectionAuthURI = "https://api.moredirect.com/service/rest/auth/oauth2?grant_type=PASSWORD&password=$connectionRetrSecret&username=GIT-CYOPS-Technical%40Domain.extension1"
# Get Authentication Token
