            ...
            for ($count = 0; $count -lt $reviewingFieldValues.Total; $count += 100) 
            {
                ...
                ForEach ($fieldValue in $fieldValues.values)
                {
                    ...
                    switch ($fieldValue.optionID) {
                        10833{$officeLocation="EVAPCO East"}
                        10834{$officeLocation="EVAPCO West"}
                        10835{$officeLocation="EVAPCO Midwest"}
                        10878{$officeLocation="EVAPCO Iowa"}
                        10879{$officeLocation="Refrigeration Vessels & Systems Corporation"}
                        10880{$officeLocation="EVAPCO Europe BVBA"}
                        10881{$officeLocation="EVAPCO (Milano) Europe, S.r.l."}
                        10882{$officeLocation="EVAPCO (Sondrio) Europe, S.r.l."}
                        10883{$officeLocation="EVAPCO (Beijing)Â Refrigeration Equipment Co., Ltd."}
                        10884{$officeLocation="EVAPCO (Shanghai) Refrigeration Equipment Co., Ltd."}
                        10887{$officeLocation="EVAPCO Australia (Pty.) Ltd."}
                        10888{$officeLocation="EvapTech, Inc."}
                        10889{$officeLocation="EVAPCO Dry Cooling, Inc."}
                        10891{$officeLocation="Tower Components, Inc."}
                        10893{$officeLocation="EVAPCO Europe A/S"}
                        10894{$officeLocation="EVAPCO Brasil"}
                        10895{$officeLocation="Fan TR"}
                        10896{$officeLocation="EVAPCO Alcoil, Inc."}
                        10897{$officeLocation="EVAPCO Air Cooling Systems (Jiaxing) Co., Ltd."}
                        10898{$officeLocation="EVAPCO Iowa Sales & Engineering"}
                        10899{$officeLocation="EVAPCO LMP"}
                        10900{$officeLocation="EVAPCO Select Tech"}
                        10901{$officeLocation="EVAPCO Europe GmbH"}
                        11959{$officeLocation="EvapTech Asia Pacific Sdn Bhd"}
                        11960{$officeLocation="EvapTech (Shanghai) Cooling Tower Co., Ltd."}
                        11979{$officeLocation="EVAPCO Middle East DMCC"}
                        11981{$officeLocation="EVAPCO S.A. (Pty.) Ltd."}
                        11986{$officeLocation="EVAPCO Newton"}
