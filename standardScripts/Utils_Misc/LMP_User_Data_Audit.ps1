...
$allLMPUsersBase = Get-MGBetaUser -all -consistencyLevel Eventual -property * | Where-Object {($_.OfficeLocation -eq 'parentCompany LMP')} | Sort-Object surname | Select-Object GivenName, SurName, Mail , CompanyName , OfficeLocation , Department , UserPrincipalName , ID 
