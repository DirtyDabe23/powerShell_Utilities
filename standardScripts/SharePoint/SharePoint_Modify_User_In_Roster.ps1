...
Connect-PNPOnline -url "https://parentCompanyinc.sharepoint.com/EmployeeRoster/Location/" -Interactive
Get-PNPList
...
#Email_x0020_Address              david.drosdick@Domain.extension1
		

#search for the user and return all values stored in their entry.
$user = (Get-PnPListItem -List "Location Office Employee Roster").fieldvalues | where-object {$_.Email_x0020_Address -eq "david.drosdick@Domain.extension1"}
	
#Example of how the user modification would work programmatically	
$toMod = "david.drosdick@Domain.extension1"
