...
Connect-PNPOnline -url "https://evapcoinc.sharepoint.com/EmployeeRoster/Taneytown/" -Interactive
Get-PNPList
...
#Email_x0020_Address              david.drosdick@evapco.com
		

#search for the user and return all values stored in their entry.
$user = (Get-PnPListItem -List "Taneytown Office Employee Roster").fieldvalues | where-object {$_.Email_x0020_Address -eq "david.drosdick@evapco.com"}
	
#Example of how the user modification would work programmatically	
$toMod = "david.drosdick@evapco.com"
