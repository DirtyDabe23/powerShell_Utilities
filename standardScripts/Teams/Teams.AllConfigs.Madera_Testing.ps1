...
$csvPath = "C:\Users\david.drosdick\OneDrive - Evapco, Inc\Documents\_Project\VOIP\EVAPCO West\TeamsPhones_testing.csv"
...
$evapcoGreeting = "You have reached the voicemail of $($user.'Display Name').  Please leave a message at the tone.  When finished recording simply hang up to deliver the message or press 0 for more options."
Write-Host "Updating Voicemail Setting for:" $user.'Display Name'
Write-Host "Voicemail message for user is: $evapcoGreeting`n"    
#Testing a configuration change.
Set-CsOnlineVoicemailUserSettings -Identity $user.UserPrincipalName -CallAnswerRule VoicemailWithTransferOption -TransferTarget $phoneNumber -DefaultGreetingPromptOverwrite "$evapcoGreeting" 
