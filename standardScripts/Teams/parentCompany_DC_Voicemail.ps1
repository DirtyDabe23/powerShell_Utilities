...
$users = Get-MGBetaUser -consistencylevel eventual -count userCount -filter "endsWith(UserPrincipalName, '@parentCompanydc.com')" 
$users | Export-CSV -Path C:\Temp\2023_08_18_parentCompanyDCUsers.csv
