...
$users = Get-MGBetaUser -consistencylevel eventual -count userCount -filter "endsWith(UserPrincipalName, '@evapcodc.com')" 
$users | Export-CSV -Path C:\Temp\2023_08_18_EvapcoDCUsers.csv
