...
start-azautomationRunbook -AutomationAccountName "GIT-Infrastructure-Automation" -Name "User-Transfer-5-create-local-74" -ResourceGroupName "EvapcoGIT" -RunOn $destinationHybridWorkerGroup  -Parameters $destinationRunbookParameters  -Wait
...
start-azautomationRunbook -AutomationAccountName "GIT-Infrastructure-Automation" -Name $runbook -ResourceGroupName "EvapcoGIT" -RunOn $destinationHybridWorkerGroup  -Parameters $destinationRunbookParameters -verbose
