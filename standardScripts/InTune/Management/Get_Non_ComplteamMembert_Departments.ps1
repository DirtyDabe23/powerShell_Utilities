...
$jiraVaultName = 'jiraAPIKeyKeyKey'
$jiraAPIKeyKeyKeyVersion = "2020-06-01"
$jiraResource = "https://vault.azure.net"
$jiraEndpoint = "{0}?resource={1}&api-version={2}" -f $env:IDENTITY_ENDPOINT,$jiraResource,$jiraAPIKeyKeyKeyVersion
$jiraSecretFile = ""
try
{
