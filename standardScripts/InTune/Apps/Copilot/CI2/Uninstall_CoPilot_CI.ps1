...
$evapcoPrograms = Get-AppxPackage -AllUsers | Where-Object {($_.publisher -like "$publisherName") -and ($_.Name -notlike "*sharepoint*")}
ForEach ($evapcoProgram in $evapcoPrograms)
{
    ...
    If (Test-path $progName)
    {
        ...
        If($xmlValues.Node.DisplayName -like $dispName)
        {
            ...
            Remove-AppXPackage -Package $evapcoProgram -AllUsers
        }

    }

}
$evapcoProgramsUser = Get-AppxPackage | Where-Object {($_.publisher -like "$publisherName") -and ($_.Name -notlike "*sharepoint*")}
ForEach ($evapcoProgram in $evapcoProgramsUser)
{
    Set-Location $evapcoProgram.installLocation
    If (Test-path $progName)
    {
