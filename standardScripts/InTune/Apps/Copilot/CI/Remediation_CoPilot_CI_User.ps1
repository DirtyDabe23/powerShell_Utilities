...
$uri = "https://ci-copilot.evapco.com/CoPilot.Client/CoPilot.Package.appinstaller"
$outFile = "C:\Temp\CoPilotCI.Package.AppInstaller"


$evapcoPrograms = Get-AppxPackage  | Where-Object {($_.publisher -like "$publisherName")}
$installed = $false
