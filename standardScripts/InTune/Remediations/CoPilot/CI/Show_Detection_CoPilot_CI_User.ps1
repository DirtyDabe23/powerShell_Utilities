...
CLS
$intial = Get-Location 
$evapcoPrograms = Get-AppxPackage -AllUsers  | Where-Object {($_.publisher -like "*Evapco*")}
ForEach ($evapcoProgram in $evapcoPrograms)
{
    ...
    If (Test-path ".\Copilot.exe"){
        ...
        Write-Output "[$now] $user : Detected $($xmlValues.Node.DisplayName) Version $($evapcoProgram.Version)"
    }
}
...
# ddKELPamYNBv7+XWaXLOXMuKGiAnWvIypwTxUVmqIOVOhVBrQ7b1HiqKN2hXldov
