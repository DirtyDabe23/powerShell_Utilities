#admin
$publisherName = "*Evapco*"
$evapcoPrograms = Get-AppxPackage -AllUsers  | Where-Object {($_.publisher -like "$publisherName") -and ($_.Name -notlike "$publisherName")}
ForEach ($evapcoProgram in $evapcoPrograms)
{
Remove-AppXPackage -package $evapcoProgram.PackageFullName -AllUsers
}

$prodURI = "https://copilot.evapco.com/CoPilot.Client/CoPilot.Package.appinstaller"
$qaURI = "https://qa-copilot.evapco.com/CoPilot.Client/CoPilot.Package.appinstaller"
$ciURI = "https://ci-copilot.evapco.com/CoPilot.Client/CoPilot.Package.appinstaller"
