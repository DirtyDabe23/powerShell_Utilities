...
Start-Process -FilePath "\\evapcousers\departments\IR-Engineering\SE 2024 Install\Solid_Edge_2024_2310.exe" -ArgumentList '/s /v" /qn"' -Wait
Start-Process -FilePath "\\evapcousers\departments\IR-Engineering\SE 2024 Install\Solid_Edge_MSI_Update0005.exe" -ArgumentList '/s /v" /qn"' -Wait
