...
$pendingRequests = Invoke-RestMethod -Method get -uri 'https://evapco.atlassian.net/rest/api/2/search?jql=summary%20~%20"Bulk%20Manager%20Change"' -Headers $headers
...
# tW/zN0yLlvtrI7b9hQbxdRPFq0A5/FNPfl37hUICFAc61JtwSZXOL3VLiAn9qglf
