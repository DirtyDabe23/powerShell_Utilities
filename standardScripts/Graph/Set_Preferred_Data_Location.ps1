...
ForEAch ($Location in $officeLocations.OfficeLocation){
    switch ($location) {
        'EvapTech, Inc.' {$dataRegion = "NAM"
        $usageLocation = "US"}
        'EVAPCO Select Tech'{$dataRegion = "NAM"
        $usageLocation = "US"}
        'EVAPCO (Beijing) Refrigeration Equipment Co., Ltd.'{$dataRegion = "NAM"
        $usageLocation = "CN"}
        'EVAPCO Europe A/S'{$dataRegion = "EUR"
        $usageLocation = "DK"}
        'EVAPCO Midwest'{$dataRegion = "NAM"
        $usageLocation = "US"}
        'EVAPCO (Shanghai)  Refrigeration Equipment Co.,Ltd'{$dataRegion = "NAM"
        $usageLocation = "CN"}
        'Indaiatuba'{$dataRegion = "IND"
        $usageLocation = "IN"}
        'Refrigeration Vessels & Systems Corporation'{$dataRegion = "NAM"
        $usageLocation = "US"}
        'EVAPCO LMP'{$dataRegion = "CAN"
        $usageLocation = "CA"}
        'EVAPCO Alcoil, Inc.'{$dataRegion = "NAM"
        $usageLocation = "US"}
        'Fan TR'{$dataRegion = "BRA"
        $usageLocation = "BR"}
        'EVAPCO (Shanghai) Refrigeration Equipment Co., Ltd.'{$dataRegion = "NAM"
        $usageLocation = "CN"}
        'EvapTech (Shanghai) Cooling Tower Co., Ltd.'{$dataRegion = "NAM"
        $usageLocation = "CN"}
        'Itu'{$dataRegion = "EUR"
        $usageLocation = "IT"}
        'EVAPCO East'{$dataRegion = "NAM"
        $usageLocation = "US"}
        'EVAPCO Air Cooling Systems (Jiaxing) Co., Ltd.'{$dataRegion = "NAM"
        $usageLocation = "CN"}
        'EVAPCO Iowa'{$dataRegion = "NAM"
        $usageLocation = "US"}
