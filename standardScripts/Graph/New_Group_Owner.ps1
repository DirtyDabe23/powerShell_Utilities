...
foreach ($group in $groups) {
    Add-UnifiedGroupLinks -Identity $group.Identity -LinkType Members -Links "david.drosdick@evapco.com" -WhatIf
}
foreach ($group in $groups) {
    Add-UnifiedGroupLinks -Identity $group.Identity -LinkType Owners -Links "david.drosdick@evapco.com" -WhatIf
}
...
$groupId = "Test_Group1"
$userId = "David.Drosdick@evapco.com" # Replace with the ID or UPN of the user you want to add
...
#version 2
$groupId = "Test_Group1"
$userId = "Brandon.Ulsh@evapco.com" # Replace with the ID or UPN of the user you want to add
