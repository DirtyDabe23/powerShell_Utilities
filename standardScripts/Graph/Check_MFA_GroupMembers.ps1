...
Write-Host "Enter the Domain to check. Example = @evapco.com"
...
# driHS9IAnJkqJ1/ZlbSdCRgQr7ckxHSQo9xXRBZhZpr6N3TJYcrTUfJ07WIL14yf
...
# IanhGA8yMDI1MDQyNTEzNTM1OFowAwIBAaBXpFUwUzELMAkGA1UEBhMCQkUxGTAX
