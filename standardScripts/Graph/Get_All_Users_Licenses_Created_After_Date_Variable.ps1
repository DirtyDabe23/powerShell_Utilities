...
$userData | Export-Csv -Path "C:\Users\$userName\OneDrive - uniqueParentCompany, Inc\Documents\_Project\Budgets\2024 Budget\2024-11-26_UserLicenseInfo.csv" -NoTypeInformation
