...
Start-Process -FilePath "C:\Program Files\AzureConnectedMachineAgent\azcmagent.exe" -ArgumentList  "connect" , "--resource-group 'AzureARC_parentCompanyEAST'" , "--tenant-id graphTenantID" , '--location EastUS' , "--subscription-id azSubsription" -NoNewWindow
