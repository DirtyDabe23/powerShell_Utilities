...
Start-Process -FilePath "C:\Program Files\AzureConnectedMachineAgent\azcmagent.exe" -ArgumentList  "connect" , "--resource-group 'AzureARC_EvapcoEAST'" , "--tenant-id 9e228334-bae6-4c7e-8b7f-9b0824082151" , '--location EastUS' , "--subscription-id ea460e20-c6e3-46c7-9157-101770757b6b" -NoNewWindow
