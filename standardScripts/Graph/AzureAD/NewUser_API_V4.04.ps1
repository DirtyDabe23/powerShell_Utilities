...
If ($softwareNeeds -contains 'LOBApp2') -or ($workLoc -eq "Shop")
{
...
Invoke-RestMethod -Uri "https://parentCompany.atlassian.net/rest/api/2/issue/$($subTaskKey)" -Method Put -Body $jsonPayload -Headers $headers
