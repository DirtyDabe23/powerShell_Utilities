...
$pendingRequests = Invoke-RestMethod -Method get -uri 'https://parentCompany.atlassian.net/rest/api/2/search?jql=summary%20~%20"TEST%20Onboard%20Request"' -Headers $headers
