...
$PasswordProfile.Password = "parentCompany123!"
...
#Phone Number Configuration - $udata.customfield_10693 is the location selector. If the location is set for Location, we will modify their phone settings
    #If ($udata.customfield_10693.value -eq "Location")
	    #{ 
    ...
    #Else
	    #{
		  #Write-Host "User: $displayName is not in Location. No phone system modification made."  
	    #}
