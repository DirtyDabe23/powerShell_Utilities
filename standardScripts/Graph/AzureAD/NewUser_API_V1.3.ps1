#Connect to the cloud services required to create new users. This will be changed to API/Token Based Authentication in future builds
#Connect-AzureAD
...
$Text = ‘david.drosdick@evapco.com:$jiraRetrSecret’
...
$Form = Invoke-RestMethod -Method get -uri "https://evapco.atlassian.net/rest/api/2/issue/$TicketNum" -Headers $headers
...
$PasswordProfile.Password = "Evapco123!"
...
-TelephoneNumber $uData.customfield_10767`
...
$userObjID = (Get-MGUser -UserID $emailAddr).ID
 ...
 #Updates the custom attributes that New-AzureADUser cannot modify
  Update-MgUser -UserId "$userObjID" `
...
#Phone Number Configuration - $udata.customfield_10693 is the location selector. If the location is set for Taneytown, we will modify their phone settings
    #If ($udata.customfield_10693.value -eq "Taneytown")
	    #{ 
		    #Write-Host "Modifying Phone Settings for $displayName"
		    #Set-CsOnlineVoicemailUserSettings -Identity $emailAddr -CallAnswerRule VoicemailWithTransferOption -TransferTarget $udata.customfield_10767
		    #Set-CsUserCallingSettings -Identity $emailAddr -IsUnansweredEnabled $true -UnansweredTargetType Voicemail -UnansweredDelay 00:00:20
            
	    #}
    #Else
	    #{
		  #Write-Host "User: $displayName is not in Taneytown. No phone system modification made."  
	    #}
	
# SIG # Begin signature block
# MIIumQYJKoZIhvcNAQcCoIIuijCCLoYCAQExDzANBglghkgBZQMEAgEFADB5Bgor
# BgEEAYI3AgEEoGswaTA0BgorBgEEAYI3AgEeMCYCAwEAAAQQH8w7YFlLCE63JNLG
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBK9+KGtg5oLS7t
# JnrK5mpu2wGHPY9PMT1QU866JknpK6CCFAUwggWQMIIDeKADAgECAhAFmxtXno4h
...
# MAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIBW0zSELuiCwIUrcMTbsRbYf
# hD37V1i+20hgjFW1tbtCMA0GCSqGSIb3DQEBAQUABIICAHwd/u6EH3PI6cmgN8T4
# LF8wVygP0QMULQprnp3cLYwCHJIBhYEWu5thg894ykLXOEqoG6E461aO5WlKr5PJ
# XWW5XWT/XSyMpPQpe15AGU4s3m7fZ/ETvxmIScuN4C3RcN8GzOZnHCS1CVpbu40J
# SQT5MiCJjaR8cZfBuep16Lhnv+JmkS1Lq3K1cMdbCXy5i2SeISLietD6yw//B43Q
# yWO3WOikQzQFxixtUOsKr2vQv80BDFNb3iZrPUD2bmsnoAEU33f0JsLE5uIhetKG
# IwdR8DbQ/HhnGSIQHsToltDqOT0fYa345Rk+NiO9SA+xKmaFjf5JQ3LuKDVVbdlf
# 5V89SPtxOj3K+XZKDUp0fSPQSeMMo3XwF1uIQDsSG4eaX8mw1YTzWPctCGUQyiVh
# 9Lar+kTSGvCYGIpL7+lUyZTsp2/z+WjQxRDnP/1iTQ10TDjJhEaGTgVzy9A6+J8J
# N0Dqgcx+h517nrOuhf83FcxneBZeOyGEQ+cmGD4bdg5Ze0WCh9KJD1zKsdZdbiHJ
# JjwlCtbOU32lBlqEf/BsMuEihWYJHXGkFDSIJ2y9EqBv6exSaNmeNuN4uz02yMjU
# RIHJLbV/SZwL0i0D6w3v4y41Q0E8G1RnyssR+aCc7M/B6h0P0pcIk93zHgP0qFzZ
# Nt0mAN4DMXhsZwysvZ3lPmJOoYIWtzCCFrMGCisGAQQBgjcDAwExghajMIIWnwYJ
# KoZIhvcNAQcCoIIWkDCCFowCAQMxDTALBglghkgBZQMEAgEwgdwGCyqGSIb3DQEJ
# EAEEoIHMBIHJMIHGAgEBBgkrBgEEAaAyAgMwMTANBglghkgBZQMEAgEFAAQgMoo5
# fdW1rKFKQaVitZ556Jp3iBOJat9G8L+vCCce8pECFCmzTY1f4lQVKIDBaEyvRpsM
# hLtbGA8yMDI1MDQyNTEzMzY1OVowAwIBAaBXpFUwUzELMAkGA1UEBhMCQkUxGTAX
...
# SAFlAwQCAaENBgkqhkiG9w0BAQsFADAvBgkqhkiG9w0BCQQxIgQgJZe+xJmYB3zo
# VxS4+2VEn17JGUwyUBOg41ZyImvWTXkwgbAGCyqGSIb3DQEJEAIvMYGgMIGdMIGa
...
# m3hD4Jl1lGN3CzANBgkqhkiG9w0BAQsFAASCAYA7ewNjzuPUUnX4L+KnTKCxSred
# Fvy2SrHJvVu2QQl2oa3H/6pHYB839udHJ7FFExI0EU618oB1TJ/TEUF9qNhPUCB+
# Y2zJjGnVvqy3QG329e1arqpRPm4gqp5dU5OaTwGbNVqtxcjOJIxPxPN5zDTsKnnh
# KdohHXkzDP1htMGqeNnHtqTR98gBrs8Vfg2T9Eq5Lmmks/0rXJFDXDaWfmA+rQRd
# pd8WPLpfwrduOIdFOob3pfI9/zjF67BHIgyVthCwNG4luryzcLGkP38dHirHMOk5
# 5/llL0sX+v6+7Pwii/ll0QMWqQWwEn6FC3JIMvdM5sQCKOI/6lj0ZAVX2GwBsnpx
# O8njpspNnSgOqyE2Og7J6H6dZACQ0XfuOIAqp/jz+kE2QTSFWD4G7DwVLU4Rbr+E
# t5YfHRqY8YJvM76fcjpnNq49bbZogXPxGE0pIjkYksc6dPYh0qWQ97Ebj+LqYJ8c
# WZWklbspoQvgW5VVU4/RZDRyH9lytgYJMAaPJe4=
