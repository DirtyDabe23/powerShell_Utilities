...
$users = Get-MsolUser -All | Where-Object { ($_.Licenses.AccountSKUID -like "*SPE_E5*") -and ($_.office -eq "EVAPCO East") }
...
# XsX1LVjFC4zUpiKgiAnt3DvNNFyZMqI0Q/r+Qa6OBpyyWBGcCv3gyKqh09kfYBLN
