...
$users = Get-MSOLUser -all | Where-Object {($_.UserPrincipalName -like "*@evapco-alcoil.com") -and ($_.passwordneverexpires -eq $false) -and (($_.LastPasswordChangeTimeStamp).AddDays(90) -lt (Get-Date))}
