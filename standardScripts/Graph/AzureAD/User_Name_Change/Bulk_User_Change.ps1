...
$userImport = "\\parentCompanyusers\departments\Public\Tech-Items\Script Configs\parentCompanyHQ_Shop.csv"
...
Rename-parentCompanyUser -currentUserName $user.currentUPN -newUPN $user.newUPN -auto
}
}
