...
$userImport = "\\evapcousers\departments\Public\Tech-Items\Script Configs\EvapcoHQ_Shop.csv"
...
Rename-EvapcoUser -currentUserName $user.currentUPN -newUPN $user.newUPN -auto
}
}
