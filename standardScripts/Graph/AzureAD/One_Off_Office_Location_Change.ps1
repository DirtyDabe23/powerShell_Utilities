Clear-Host
$evaptechAP = 'EvapTech (Shanghai) Cooling Tower Co., Ltd.'
$evapcoBeijing = 'EVAPCO (Beijing) Refrigeration Equipment Co., Ltd.'
$evapcoShang = 'EVAPCO (Shanghai) Refrigeration Equipment Co., Ltd.'
$evapcoJiaxing = 'EVAPCO Air Cooling Systems (Jiaxing) Co., Ltd.'

$switchCase = Read-Host -Prompt "1: $evapTechAP `n2: $evapcoBeijing `n3: $evapcoShang `n4: $evapcoJiaxing`nSelect what company you would like to map"



switch ($switchCase)
{
    1{$officeLoc = $evaptechAP}
    2{$officeLoc = $evapcoBeijing}
    3{$officeLoc = $evapcoShang}
    4{$officeLoc = $evapcoJiaxing}
