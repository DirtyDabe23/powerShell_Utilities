...
{
If ($user.PrimarySmtpAddress -match "EvapcoMW.com")
{

Remove-DistributionGroupMember -Identity "Evapco Evaptech Distro" -member $user.PrimarySmtpAddress -confirm:$false
}
}
