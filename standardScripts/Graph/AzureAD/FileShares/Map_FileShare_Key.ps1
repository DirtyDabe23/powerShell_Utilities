...
if ($connectTestResult.TcpTestSucceeded) {
    ...
    cmd.exe /C "cmdkey /add:`"ttprodfileshare.file.core.windows.net`" /user:`"localhost\ttprodfileshare`" /pass:`"YLP3xmBUU8cUKnWc39K38oxNELpdryPYQvCFVFQp+z/UqYwZLel6vlr8FhXIfeuZnyBlLwEHVMKD+AStvpOacw==`""
    # Mount the drive
