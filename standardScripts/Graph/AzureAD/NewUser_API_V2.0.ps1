...
$managerID = (Get-MGUser -Filter "startsWith(DisplayName,'$tempvar')" -ConsistencyLevel:eventual -top 1).id
...
#Group1
    ...
    else 
    {
        ...
        try 
            {
            New-MGGroupMember -GroupId $gname -DirectoryObjectId $userObjID -erroraction stop
            } 
        catch 
            {
            ...
            try
                {
                Add-DistributionGroupMember -Identity $gname -member $emailAddr -BypassSecurityGroupManagerCheck -erroraction stop
                }
            catch
                {
...
#Group3    
    ...
    else 
    {
        ...
        try 
            ...
            try
                {
                Add-DistributionGroupMember -Identity $gname -member $emailAddr -BypassSecurityGroupManagerCheck -erropraction stop
                }
            catch
                {
    ...
    #add user to the MFA Enabled Group
...
"@ 
    Invoke-RestMethod -Uri "https://evapco.atlassian.net/rest/api/2/issue/$TicketNum/transitions" -Method Post -Body $jsonPayload -Headers $headers
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDyT9H9/Il14E33
# /pW4CDgrQhgta4uD9X5sPWQHuH32raCCFAUwggWQMIIDeKADAgECAhAFmxtXno4h
...
# MAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIIXe8jb1lHuYXM1aYvY96kq8
# tYikFwuLRPhPiGDxKQzNMA0GCSqGSIb3DQEBAQUABIICABc4Mi+tnWs4HRoBj/pn
# DIumAAAiL69eAK86Y3NN382s2LExjWjuDUYGuZebsrpLTDOIpPTCSVOAyAEyj+hu
# bcegU+ygXRRtNgDQ2mMzDbrhao2nF3excZIDLSNtLU/RAhbrnElNeLJJ/8kz/QAn
# E6WdbmH5QphBhEiZ2l54XwlLXNG1M7AhlB3VdsFUo7vDMerwwDA0yolWNEPrMZvU
# onF9WzVTxSCzU7o+OBbJbG5mLB63mA5Aa5OZ3NcSxdGbmdw+lOT3vHmuDEDIMWAp
# DQmVdZ5vAwFwOP7rDP1iS/bsKFDZesKeLhnxUA3jf9SCVNaPYoWZypUy2y/QMJdt
# 2WZnrWp9TtGoVNJi2gyQXObGcO12hZFjRfOMOB2qaSconuGuV9K2G3PQyk9CWN9A
# +Q3DP36uI+ZVxV+gbjmzAGJyz+9OciuVEJm0zPkekrOfuVCNhTG0zTEwv63Pl7Dc
# 3Ht2uzzUsT3ZLIw3lCiM6jngBORvyCw1AG4dDrCuddp8M7jxtDRS93wzbXGr9YMK
# a8OfNi2/2JindnQMZvS/PLd1vzA7qPSQU87vbYTYO0M8EgxNDR9UiM/zmGF5k4F5
# GCmaCbhvePToVTLT9w8R3mosFZmbmcxalrw1PLgNr6BZY4h42910cGCNSypBLKxx
# w1UCNhd/i3f85bndha/5cGKHoYIWtzCCFrMGCisGAQQBgjcDAwExghajMIIWnwYJ
# KoZIhvcNAQcCoIIWkDCCFowCAQMxDTALBglghkgBZQMEAgEwgdwGCyqGSIb3DQEJ
# EAEEoIHMBIHJMIHGAgEBBgkrBgEEAaAyAgMwMTANBglghkgBZQMEAgEFAAQgZCxc
# bxT5wOvt2pJW+GQQBZzDDEMa28aMo07fO1IDqNwCFHKDwPsmlQHhLTB3InvLnUCT
# 48SjGA8yMDI1MDQyNTEzNTQyNVowAwIBAaBXpFUwUzELMAkGA1UEBhMCQkUxGTAX
...
# SAFlAwQCAaENBgkqhkiG9w0BAQsFADAvBgkqhkiG9w0BCQQxIgQgi9dvoORxp0Ld
# rAg6ql2SCwG4fhZUntofodkkg1Zs8zYwgbAGCyqGSIb3DQEJEAIvMYGgMIGdMIGa
...
# m3hD4Jl1lGN3CzANBgkqhkiG9w0BAQsFAASCAYBYSZSSB2OEzJoA5Y9nRrg7fk0l
# TRvCE1yyb47edGzdZlnvGd5Y19bmsnlSH7FfPSfg21PPBykEVU1RuzJ9+AfBAH9h
# mOs/ulQUeNAAY4NLPEL6Z7Dsrod9f2Dh8TOVvEXGb9SgQN1D1GssM8u6bGom3hIB
# LJ+geVXPuqRNej5e+J4fazMNfo9oNtCtNbFQFJMBQ/ukbRKrTGGuxo106uhiEeeN
# s3dZiq08yOhz7g3GQa+/fFiCxLePJlpT7OJWvtSE0cg2Zb6yEqJVmbyk6uFXsvL4
# yBG6V84rA8xYo3ispj0fnmWrltKRtctuBtxlOHaH+L3nkzbPSj/jM09dCLYvdlFE
# QrcVlfMRo5Xthfl5hz9meM8+nVg++/a+T/VcWsS2/62mPNBpc8tOiQcTmaqCXEA5
# jFmckyopYpU0FRBBTtF98Cj4sDBNx6Ups5CvnyCCWplZAR7hXhXyXdSJWs+ODfj6
# xjw8x+aWnmUCa/z7CjbUrQaz97pdoYVgEzksxsw=
