Get-MGBetaUser -All -ConsistencyLevel eventual | Where-Object {($_.OfficeLocation -eq "Refrigeration Vessels & Systems Corporation") -or ($_.OfficeLocation -eq "EvapTech, Inc.") -or ($_.OfficeLocation -eq "EVAPCO Dry Cooling, Inc.") -or ($_.OfficeLocation -eq "Tower Components, Inc.") -or ($_.OfficeLocation -eq "EVAPCO Alcoil, Inc.") -or ($_.OfficeLocation -eq "EVAPCO Iowa Sales & Engineering") -or ($_.OfficeLocation -eq "EVAPCO Select Tech") -and ($_.CompanyName -ne "Not Affiliated") } | select-object -property displayname, userprincipalname, officelocation | sort-object -Property "OfficeLocation","DisplayName"  | Export-CSV -Path C:\Temp\2024_04_24_RequestedUsers.csv -force
