...
foreach ($user in $users) {
  # Check if the user's office location is "Evapco, Inc"
  if ($user.OfficeLocation -eq "Evapco East") {
...
# zTt05v4OVyR41X8rRAA+r/XDuAIrFSMHW8l02dMTCI1fYXfL0DVIyuFEPVC5cPKp
...
# k2SBGwNgeC6tox8iluEof5eda1hxtR5OiRw0E0yYZFoRxtCI96jOaXabwIHBVuQ=
