...
$userData | Export-Csv -Path "C:\Users\David.drosdick\OneDrive - Evapco, Inc\Documents\2023_Scripts\Azure_AD\Audits\Users_Created_By_Date_Licenses\Created_2023_UserLicenseInfo.csv" -NoTypeInformation
