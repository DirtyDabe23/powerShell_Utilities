...
$retrSecret = (Invoke-RestMethod -Uri 'https://KeyVaultName.vault.azure.net/secrets/GraphAPIKey?api-version=2016-10-01' -Method GET -Headers @{Authorization="Bearer $token"}).value
...
$validCompanyNames = "parentCompany, Inc.","parentCompany Alcoil, Inc.","parentCompany Dry Cooling, Inc.","subsidiaryCompany1","subsidiaryCompany2, Inc.","subsidiaryCompany4","parentCompany Refrigeration Equipment Co., Ltd","parentCompany Air Cooling Systems Company, Ltd","FanTR Technology Resource","parentCompany LMP","parentCompany Select Technologies, INC.","parentCompany Australia (Pty.) Ltd.","parentCompany Europe GmbH","parentCompany Europe A/S","parentCompany Iowa Sales & Engineering","parentCompany Europe, S.r.l.","parentCompany Europe BVBA","subsidiaryCompany2 (Shanghai) Cooling Tower Co., Ltd.","subsidiaryCompany2 Asia Pacific Sdn Bhd","parentCompany Brasil" , "parentCompany Middle East DMCC" , "parentCompany S.A. (Pty.) Ltd."
