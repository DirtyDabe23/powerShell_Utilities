...
$officloc = Get-MGBetauser -UserId "dona.swarts@rvscorp.com" | select officelocation
$allRVSUsers = $allAADUsers | where-object {($_.OfficeLocation -eq $officloc.officelocation) -and ($_.CompanyName -ne "Not Affiliated")}


$ExchangeAttrs = @()
ForEach ($user in $allRVSUsers)
{
Try
    {
