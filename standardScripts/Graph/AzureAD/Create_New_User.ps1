...
foreach ($user in $users) {
    ...
    switch ($user.Location) {
        "Taneytown" { $suffix = "@Evapco.com" }
        "Madera" { $suffix = "@evapcowest.com" }
        "Greenup" { $suffix = "@evapcomw.com" }
        "Iowa" { $suffix = "@evapcoia.com" }
        "Texas" { $suffix = "@rvscorp.com" }
        "Tongeren" { $suffix = "@evapco.be" }
        "Beijing" { $suffix = "@evapcochina.com" }
        "Shanghai" { $suffix = "@evapcochina.com" }
        "Australia" { $suffix = "@evapco.com.au" }
        "Evapco Dry Cooling" { $suffix = "@evapco-blct.com" }
        "Tower Components" { $suffix = "@towercomponentsinc.com" }
        "Newton" { $suffix = "@evapcomw.com" }
        "Denmark" { $suffix = "@evapco.de" }
        "Evapco-Brasil" { $suffix = "@evapco.com.br" }
        "Fan TR" { $suffix = "@fantr.com" }
        "Minnesota" { $suffix = "@evapcomn.com" }
        "Evapco LMP" { $suffix = "@lmpinc.ca" }
        "Evapco Select Tech" { $suffix = "@evapcoselect.com" }
