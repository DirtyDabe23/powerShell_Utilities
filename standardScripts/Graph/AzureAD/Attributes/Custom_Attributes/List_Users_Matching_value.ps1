...
$userAttributes = Get-MgUser -CountVariable CountVar -Property "id,displayName,customSecurityAttributes" -Filter "customSecurityAttributes/Evapco/WorkLocation eq 'Office'" -ConsistencyLevel eventual
