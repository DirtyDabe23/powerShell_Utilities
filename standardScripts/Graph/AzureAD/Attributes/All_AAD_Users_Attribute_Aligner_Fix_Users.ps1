...
{
    If ($user.CompanyName -eq "EVAPCO Alcoil Inc")
    {
    Write-Host "$($user.DisplayName) company name is being updated"
    Update-MGUser -UserId $user.UserPrincipalName -CompanyName "EVAPCO Alcoil, Inc." 
    }
    ...
    Update-MGUser -UserId $user.UserPrincipalName -CompanyName "EVAPCO Alcoil, Inc." 
     ...
     If ($user.CompanyName -eq "Evapco-Alcoil")
    {
    Write-Host "$($user.DisplayName) company name is being updated"
    Update-MGUser -UserId $user.UserPrincipalName -CompanyName "EVAPCO Alcoil, Inc." 
    }
    ...
    {
    Write-Host "$($user.DisplayName) company name is being updated"
    Update-MGUser -UserId $user.UserPrincipalName -CompanyName "Refrigeration Vessels & Systems Corporation" 
    }
    ...
    If ($user.CompanyName -eq "RVS")
    {
    Write-Host "$($user.DisplayName) company name is being updated"
    Update-MGUser -UserId $user.UserPrincipalName -CompanyName "Refrigeration Vessels & Systems Corporation" 
    }

    If ($user.CompanyName -eq "EVAPCO Select")
    {
    Write-Host "$($user.DisplayName) company name is being updated"
    Update-MGUser -UserId $user.UserPrincipalName -CompanyName "EVAPCO Select Technologies, INC." 
    }


    If ($user.CompanyName -eq "EVAPCO Select Tech")
    {
    Write-Host "$($user.DisplayName) company name is being updated"
    Update-MGUser -UserId $user.UserPrincipalName -CompanyName "EVAPCO Select Technologies, INC." 
    }
    ...
    {
    Write-Host "$($user.DisplayName) company name is being updated"
    Update-MGUser -UserId $user.UserPrincipalName -CompanyName "Tower Components, Inc." 
    }
    ...
    Update-MGUser -UserId $user.UserPrincipalName -CompanyName "Tower Components, Inc." 
     ...
     If ($user.CompanyName -eq "EVAPCO Dry Cooling, Inc")
    {
    Write-Host "$($user.DisplayName) company name is being updated"
    Update-MGUser -UserId $user.UserPrincipalName -CompanyName "EVAPCO Dry Cooling, Inc." 
    }

     If ($user.CompanyName -eq "EvapTech, Inc")
    {
    Write-Host "$($user.DisplayName) company name is being updated"
    Update-MGUser -UserId $user.UserPrincipalName -CompanyName "EvapTech, Inc." 
    }
