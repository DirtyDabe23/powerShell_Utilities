...
$includedCompanies = $companies | Where-Object {($_.CompanyNAme -ne "") -and ($_.CompanyNAme -ne "Not Affiliated") -and ($_.CompanyName -ne $null)}
$sortedCompanies = $includedCompanies | Sort-Object -Property CompanyName
clear-Host
$sortedCompanies
