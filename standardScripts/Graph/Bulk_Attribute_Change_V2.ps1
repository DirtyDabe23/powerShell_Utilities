...
$pendingRequests = Invoke-RestMethod -Method get -uri 'https://evapco.atlassian.net/rest/api/2/search?jql=summary%20~%20"Employee%20Change"' -Headers $headers
...
Invoke-RestMethod -Uri "https://evapco.atlassian.net/rest/api/3/issue/$key/transitions" -Method Post -Body $jsonPayload -Headers $headers
Disconnect-MgGraph
     }
